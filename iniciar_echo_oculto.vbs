' Lanca o iniciar_echo.bat com a janela do console totalmente escondida - o .bat em
' si ja sobe o processo real (echo.main) escondido via pythonw, mas o CONSOLE DO
...
'
' O atalho da area de trabalho ("ECHO") aponta pra esse arquivo, nao pro .bat direto.

Set objShell = CreateObject("WScript.Shell")
Set oFso = CreateObject("Scripting.FileSystemObject")
strPastaAtual = oFso.GetParentFolderName(WScript.ScriptFullName)
objShell.Run """" & strPastaAtual & "\iniciar_echo.bat""", 0, False
